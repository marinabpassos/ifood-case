...
| `chart_image` | `analysis/charts/avg_total_amount_by_month.png` or `analysis/charts/avg_passenger_count_by_hour_may.png` — generated by `analysis/analise.py`'s per-question Python chart cell, a bar chart of `result_rows` (research.md §3, §5) |
